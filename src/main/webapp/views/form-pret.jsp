...
<div class="form-container">
    ...
    <form action="ajouterPret" method="post">
            ...
            <select name="idAdherant" id="idAdherant" required>
                ...
                <c:forEach var="adherant" items="${adherants}">
                    <option value="${adherant.idAdherant}">
                        ${adherant.nom} (ID: ${adherant.idAdherant})
                    </option>
                </c:forEach>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="numeroExemplaire" name="numeroExemplaire" placeholder="Entrer le numéro de l'exemplaire" autocomplete="off" required>
            <div id="suggestions" style="background:#fff;border:1px solid #ccc;position:absolute;z-index:10;"></div>
        </div>
